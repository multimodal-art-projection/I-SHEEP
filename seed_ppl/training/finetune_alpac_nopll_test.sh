...
accelerate launch \
    ...
    --output_dir "/ML-A100/team/mm/eamon/self_instruction/liang_ppl/models/test/lora_self_seed_ppl_1k/noppl_10k" \
    --run_tensorboard_dir True \
    --val_set_size 0 \
    --checkpointing_steps $CKPT_STEPS \
    --resume_from_checkpoint False \
    --data_path /ML-A100/team/mm/eamon/self_instruction/liang_ppl/outputs/self_seed_ppl_1k_output.json \
