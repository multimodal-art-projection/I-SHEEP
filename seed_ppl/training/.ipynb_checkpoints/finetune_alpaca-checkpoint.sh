...
export SAVE_DIR="/cpfs/29cd2992fe666f2a/user/huangwenhao/lsy/models/selfins_32_20k_7epoch/"
...
export DATA_PATH="/cpfs/29cd2992fe666f2a/user/huangwenhao/lsy/ppl_test/32_ppl_20k_inverse_direct_output.json"
# export DATA_PATH="/cpfs/29cd2992fe666f2a/user/huangwenhao/lsy/ppl_test/ppl_inverse_32_direct30k_output.json"
...
accelerate launch \
    ...
    --deepspeed_config_file /cpfs/29cd2992fe666f2a/user/huangwenhao/lsy/Dromedary/training/ds_config_zero3.json \
    finetune.py \
    --num_warmup_steps 0 \
    ...
    --output_dir "$SAVE_DIR/32_ppl_inverse_20k_direct" \
