...
export SAVE_DIR="/ML-A100/home/gezhang/aliyun_transfer/lsy_and_xw_new/lsy/models/selfins_32_60k_7epoch_direct/"
...
export DATA_PATH="/ML-A100/home/gezhang/aliyun_transfer/lsy_and_xw_new/lsy/ppl_test/32_ppl_60k_inverse_direct_output.json"
# export DATA_PATH="/ML-A100/home/gezhang/aliyun_transfer/lsy_and_xw_new/lsy/ppl_test/ppl_inverse_32_direct30k_output.json"
...
accelerate launch \
    ...
    --deepspeed_config_file /ML-A100/home/gezhang/aliyun_transfer/lsy_and_xw_new/lsy/Dromedary/training/ds_config_zero3.json \
    finetune.py \
    --num_warmup_steps 0 \
    ...
    --output_dir "$SAVE_DIR/32_ppl_inverse_40k" \
